...
SELECT ac.`Region`, COALESCE(ac.`Income Group`, 'Other') AS `Income Group`
...
ORDER BY 
  CASE 
    WHEN b.`Income Group` = 'High income' THEN 1
    WHEN b.`Income Group` = 'Upper middle income' THEN 2
    WHEN b.`Income Group` = 'Lower middle income' THEN 3
    WHEN b.`Income Group` = 'Low income' THEN 4
    ELSE 5
  END;
""")
