...
SELECT 
  ...
  (SUM(CASE WHEN `Income Group` = 'High income' THEN 1 ELSE 0 END)
   ...
   + SUM(CASE WHEN `Income Group` = 'Low income' THEN 1 ELSE 0 END)) AS `Row Total`
FROM wdi_country
GROUP BY `Region`
ORDER BY `Region`;
""")
...
FROM base b
ORDER BY FIELD(`Income Group`, 'High income', 'Upper middle income', 'Lower middle income', 'Low income');
""")
